#These will be the prediction pipeline, it will used during our recommendation purpose
...
class AnimeRecommendationPipeline:   #These pipeline used to generate the response
    def __init__(self,persist_dir="chroma_db"):
        try:
            ...
            retriever = vector_builder.load_vector_store().as_retriever()  #Loading the vector store that is already being created and these created in build_pipeline script
